...
public class Content extends BaseDataType{
	...
	public Long mContentid = null; // (optional); // Unique identifier for the file.
	
	public String mRemoteid = null;  //Unique identifier for a remote file.
	
	public String mExtfid = null; // (optional); // External identifier for the message. Internal use only.
	
	public String mTitle = null; // (optional); // Title of the file.
	
	public String mFilename = null; // (optional); // Name of the file.
	
	public String mDescription = null; // (optional); // Description of the file.
	
	public byte[] mBytes = null; // Contains the binary information of the file.
	
	public String mBytesmime = null; // Contains the mime type information of the file.
	
	public String mPreviewurl = null; // Defines an http url that the client can use to retrieve binary data of the preview image.
	
	public String mStore = null; // (optional) Name of the store type for this file. This field contains information about the originator network. By default, should be set to local
	
	public Long mTime = null; // (optional) Timestamp representing the time of the file. Can be not related to creation/updated time.
	
	public List<Tag> mTaglist = new ArrayList<Tag>(); // The list of Tags which are associated with the content item
	
	public Long mMaxage = null; // The number of seconds the file can be cached without re-requesting it
	
	public String mSystem = null; // Describes the usage of the content i.e 'profile'. Default is null.
	...
	public Integer mCommentscount; // Number of comments associated with this entity.
	
	public String mUploadedviaappid; // App id of client that uploaded the file.
	
	public String mUploadedviaapptype; // App type of client that uploaded the file.
	...
	public String mUrl;
	 ...
	 private enum Tags {
	     ...
	     ALBUMID_LIST("albumidlist"),
	     TAGS_COUNT("tagscount"),
	     COMMENTS_COUNT("commentscount"),
	     UPLOADED_VIA_APP_ID("uploadedviaappid"),
	     UPLOADED_VIOA_APP_TYPE("uploadedviaapptype"),
		 FILE_SIZE("filesize"),
		 URL("url");
	 ...
	 public Hashtable<String, Object> createHashtable() {
	  ...
	  public Content createFromHashtable(Hashtable<String, Object> hash) throws IOException{
	  ...
	  private void setValue(Tags tag, Object value) throws IOException {
	        if (tag != null) {
	            ...
	            case CONTENTID:
	            	...
	            	LogUtils.logD("Content.setValue setting content id = " + mContentid);
