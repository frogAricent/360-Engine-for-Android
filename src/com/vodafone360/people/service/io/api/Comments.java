...
public class Comments {
	 ...
	 /**
	  * Implementation of comments/addcomments API. Parameters are;
	  * [auth], List <Comment> commentlist
	  * 
	  * @param engine handle to CommentsEngine
	  * @param commentlist List of Comments to be added
	 ...
	 /**
	  * Implementation of comments/deletecomments API. Parameters are;
	  * [auth], List <Comment> list, Long ownerId
	  * 
	  * @param engine handle to CommentsEngine
	  * @param list List of Comments to be deleted
	  * @param ownerId Owner Id of the comment
	  * @return request id generated for this request
	  */	 
	 public static int deleteComment(BaseEngine engine, List <Long> list, Long ownerId) {
	        if (engine == null) {
	            throw new NullPointerException("Auth.getPublicKey() engine cannot be NULL");
	        }
	 ...
	 /**
	  * Implementation of comments/getcomments API. Parameters are;
	  * [auth], List <EntityKey> entitykeylist
	  * 
	  * @param engine handle to CommentsEngine
	  * @param entitykeylist List of entities for which comments are retrieved
	  * @return request id generated for this request
	  */	 
	 public static int getComment(BaseEngine engine, List <EntityKey> entitykeylist) {
	        if (engine == null) {
	            throw new NullPointerException("Auth.getPublicKey() engine cannot be NULL");
	        }
	        ...
	        Request request = new Request(FUNCTION_GET_COMMENT,
	                ...
	                Settings.API_REQUESTS_TIMEOUT_AUTH);
	        request.addData(ENTITY_KEY_LIST, ApiUtils.createVectorOfEntityKey(entitykeylist));
	        QueueManager queue = QueueManager.getInstance();
	        int requestId = queue.addRequest(request);
	        queue.fireQueueStateChanged();
	        return requestId;
	 ...
	 /**
	  * Implementation of comments/updatecomments API. Parameters are;
	  * [auth], List <Comment> list
	  * 
	  * @param engine handle to CommentsEngine
	  * @param list List of Comments to be updated
	  * @return request id generated for this request
	  */	 
